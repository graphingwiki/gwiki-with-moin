# -*- coding: utf-8 -*-
'''This is a Python 2.7 script for testing Collab wiki basic functionality. Modules needed for usage: Selenium webdriver and geckodriver. The script creates three new pages to the wiki: plaintextpage, graphtestpage and macrotestpage. These pages are used to test different basic functionality of the wiki. The pages are deleted at the end of the script. Change variables site, password and user to match your setup. 
